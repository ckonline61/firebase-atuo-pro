...
export default function LoginScreen() {
  ...
  const googleLoginEnabled = isEnabled('google_login');
  const phoneLoginEnabled = isEnabled('phone_login');
  const guestModeEnabled = isEnabled('guest_mode');
    ...
    <div className="login-screen" id="login-screen">
      <div className="login-content">
        ...
        <div className="login-buttons animate-fadeInUp" style={{animationDelay: '0.2s'}}>
          {featureLoading && <p className="login-feature-message">Login options loading...</p>}

          {!featureLoading && googleLoginEnabled && (
            <>
              <button
          ...
          {!featureLoading && phoneLoginEnabled && (
          ...
          {!featureLoading && (googleLoginEnabled || phoneLoginEnabled) && guestModeEnabled && (
            <div className="login-divider">
              <span>or</span>
            </div>
          )}
          
          {!featureLoading && guestModeEnabled && (
          ...
          {!featureLoading && !googleLoginEnabled && !phoneLoginEnabled && !guestModeEnabled && (
            <p className="login-feature-message">Login temporarily unavailable. Please contact support.</p>
          )}
        </div>
